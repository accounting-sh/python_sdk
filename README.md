...
Python 3.10+ with OpenSSL 1.1.1 or newer (required by urllib3 2.x).
...
*StatisticsApi* | [**summary_statistics_period**](docs/StatisticsApi.md#summary_statistics_period) | **GET** /companies/{uuid}/statistics/summary | Company&#39;s summary statistics
...
*UsersApi* | [**update_me**](docs/UsersApi.md#update_me) | **POST** /users/me | Update current user details
