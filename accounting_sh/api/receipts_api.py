...
class ReceiptsApi:
    ...
    def add_receipt(self, add_receipt_request: dict, **kwargs) -> Any | None:
        """Add a receipt
    ...
    def delete_receipt(self, uuid: str, **kwargs) -> Any | None:
        """Delete a receipt
    ...
    def get_receipt(self, uuid: str, **kwargs) -> Any | None:
        """Get a receipt
    ...
    def get_receipt_document(self, uuid: str, **kwargs) -> Any | None:
    ...
    def update_receipt(
        self, uuid: str, add_receipt_request: dict, **kwargs
    ) -> Any | None:
        """Update a receipt
