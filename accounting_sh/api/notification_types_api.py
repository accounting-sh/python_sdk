...
class NotificationTypesApi:
    ...
    def add_notification_type(
        self, add_notification_type_request: dict, **kwargs
    ) -> Any | None:
        """Add a notification type


        :param add_notification_type_request: (required)
        :type add_notification_type_request: AddNotificationTypeRequest
        ...
        if add_notification_type_request is not None:
            kwargs["json"] = add_notification_type_request
    ...
    def delete_notification_type(self, uuid: str, **kwargs) -> Any | None:
        """Delete a notification type


        :param uuid: The notification type uuid (required)
        :type uuid: str
        :return: Returns a dict containing the API Response.
        """  # noqa: E501
    ...
    def get_notification_type(self, uuid: str, **kwargs) -> Any | None:
    ...
    def update_notification_type(
        self, uuid: str, add_notification_type_request: dict, **kwargs
    ) -> Any | None:
