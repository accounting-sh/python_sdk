...
class ExportApi:
    ...
    def request_export(self, request_export_request: dict, **kwargs) -> Any | None:
        """Request an export


        :param request_export_request: (required)
        :type request_export_request: RequestExportRequest
        :return: Returns a dict containing the API Response.
        """  # noqa: E501
        ...
        if request_export_request is not None:
            kwargs["json"] = request_export_request
