...
class AccountsApi:
    ...
    def add_account(self, add_account_request: dict, **kwargs) -> Any | None:
        """Add an account
        ...
        if add_account_request is not None:
            kwargs["json"] = add_account_request
    ...
    def delete_account(self, uuid: str, **kwargs) -> Any | None:
        """Delete an account
    ...
    def get_account(self, uuid: str, **kwargs) -> Any | None:
        """Get an account
    ...
    def update_account(
        self, uuid: str, add_account_request: dict, **kwargs
    ) -> Any | None:
        """Update an account
