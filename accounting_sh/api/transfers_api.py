...
class TransfersApi:
    ...
    def add_transfer(self, add_transfer_request: dict, **kwargs) -> Any | None:
        """Add a transfer


        :param add_transfer_request: (required)
        :type add_transfer_request: AddTransferRequest
        ...
        if add_transfer_request is not None:
            kwargs["json"] = add_transfer_request
    ...
    def delete_transfer(self, uuid: str, **kwargs) -> Any | None:
        """Delete a transfer


        :param uuid: The transfer uuid (required)
        :type uuid: str
        :return: Returns a dict containing the API Response.
        """  # noqa: E501
    ...
    def get_transfer(self, uuid: str, **kwargs) -> Any | None:
        """Get a transfer
    ...
    def update_transfer(
        self, uuid: str, add_transfer_request: dict, **kwargs
    ) -> Any | None:
        """Update a transfer
