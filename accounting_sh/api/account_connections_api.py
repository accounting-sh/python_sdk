...
class AccountConnectionsApi:
    ...
    def delete_account_connection(self, uuid: str, **kwargs) -> Any | None:
    ...
    def list_connectable_bank_accounts(
        self, connection: str = None, **kwargs
    ) -> Any | None:
    ...
    def request_bank_connection(
        self, request_bank_connection_request: dict, **kwargs
    ) -> Any | None:
    ...
    def select_bank_account(
        self, select_bank_account_request: dict, **kwargs
    ) -> Any | None:
