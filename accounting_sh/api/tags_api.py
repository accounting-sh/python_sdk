...
class TagsApi:
    ...
    def add_tag(self, add_tag_request: dict, **kwargs) -> Any | None:
        """Add a tag


        :param add_tag_request: (required)
        :type add_tag_request: AddTagRequest
        ...
        if add_tag_request is not None:
            kwargs["json"] = add_tag_request
    ...
    def delete_tag(self, uuid: str, **kwargs) -> Any | None:
        """Delete a tag


        :param uuid: The tag uuid (required)
        :type uuid: str
        :return: Returns a dict containing the API Response.
        """  # noqa: E501
    ...
    def get_tag(self, uuid: str, **kwargs) -> Any | None:
        """Get a tag
    ...
    def update_tag(self, uuid: str, add_tag_request: dict, **kwargs) -> Any | None:
        """Update a tag
