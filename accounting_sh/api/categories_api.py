...
class CategoriesApi:
    ...
    def add_category(self, add_category_request: dict, **kwargs) -> Any | None:
        """Add a category
    ...
    def delete_category(self, uuid: str, **kwargs) -> Any | None:
        """Delete a category
    ...
    def get_category(self, uuid: str, **kwargs) -> Any | None:
        """Get a category
    ...
    def update_category(
        self, uuid: str, add_category_request: dict, **kwargs
    ) -> Any | None:
        """Update a category
