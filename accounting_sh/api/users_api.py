...
class UsersApi:
    ...
    def add_user(self, add_user_request: dict, **kwargs) -> Any | None:
        """Add user
    ...
    def delete_user(self, uuid: str, **kwargs) -> Any | None:
        """Delete user


        :param uuid: The user uuid (required)
        :type uuid: str
        :return: Returns a dict containing the API Response.
        """  # noqa: E501
    ...
    def get_user(self, uuid: str, **kwargs) -> Any | None:
        """View user
    ...
    def update_me(
        self, name: str = None, avatar: bytearray = None, **kwargs
    ) -> Any | None:
        ...
        if len(query_params) > 0:
            ...
            path = path + "?" + urlencode(query_params, doseq=True)
        return self.accounting.request(method="PATCH", path=path, **kwargs)

    def update_user(self, uuid: str, update_user_request: dict, **kwargs) -> Any | None:
        """Update user
        ...
        if update_user_request is not None:
            kwargs["json"] = update_user_request
    ...
    def users_companies(self, **kwargs) -> Any | None:
    ...
    def users_me(self, **kwargs) -> Any | None:
